...
class ConnectionManager_sendFile_1_accepted_1(
    ...
    override fun create(obj: Any, continuation: Continuation<*>): Continuation<Unit> {
        return ConnectionManager_sendFile_1_accepted_1(this.deferred, continuation)
    }

    override fun invoke(coroutineScope: CoroutineScope, continuation: Continuation<Boolean>): Any {
        return (create(coroutineScope, continuation) as ConnectionManager_sendFile_1_accepted_1).invokeSuspend(Unit)
    }

...
class ConnectionManager_sendStatusReport_1(
    ...
    override fun create(obj: Any, continuation: Continuation<*>): Continuation<Unit> {
        return ConnectionManager_sendStatusReport_1(this.msg, continuation)
    }

    override fun invoke(coroutineScope: CoroutineScope, continuation: Continuation<Unit>): Any {
        return (create(coroutineScope, continuation) as ConnectionManager_sendStatusReport_1).invokeSuspend(Unit)
    }

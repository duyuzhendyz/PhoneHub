...
class ConnectionManager_handlePcMessage_8(
    ...
    override fun create(obj: Any, continuation: Continuation<*>): Continuation<Unit> {
        return ConnectionManager_handlePcMessage_8(this.fileId, continuation)
    }

    override fun invoke(coroutineScope: CoroutineScope, continuation: Continuation<Unit>): Any {
        return (create(coroutineScope, continuation) as ConnectionManager_handlePcMessage_8).invokeSuspend(Unit)
    }

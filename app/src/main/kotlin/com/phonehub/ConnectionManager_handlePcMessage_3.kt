...
class ConnectionManager_handlePcMessage_3(
    ...
    override fun create(obj: Any, continuation: Continuation<*>): Continuation<Unit> {
        return ConnectionManager_handlePcMessage_3(this.historyList, continuation)
    }

    override fun invoke(coroutineScope: CoroutineScope, continuation: Continuation<Unit>): Any {
        return (create(coroutineScope, continuation) as ConnectionManager_handlePcMessage_3).invokeSuspend(Unit)
    }

    override fun invokeSuspend(result: Any): Any {
        var mutableSharedFlow: MutableSharedFlow<List<Map<String, Any?>>>? = null

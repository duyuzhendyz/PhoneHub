...
class ConnectionManager {
    ...
    public ConnectionManager$startPcFramePolling$1(Continuation<? super ConnectionManager$startPcFramePolling$1> continuation) {
        super(2, continuation)
        }

    override
    fun create(obj: Any, continuation: Continuation<?>): Continuation<Unit> {
        ConnectionManager$startPcFramePolling$1 connectionManager$startPcFramePolling$1 = new ConnectionManager$startPcFramePolling$1(continuation)
        connectionManager$startPcFramePolling$1.L$0 = obj
        return connectionManager$startPcFramePolling$1
        }

    override
    fun invoke(coroutineScope: CoroutineScope, continuation: Continuation<? super Unit>): Any {
        return ((ConnectionManager$startPcFramePolling$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE)
        }
    ...
    */
    fun invokeSuspend(/* Object $result */): Any {
        ...
        var mutableSharedFlow2: MutableSharedFlow? = null
        ...
        switch (this.label) {
                ...
                if (mutableStateFlow.getValue() == ConnectionManager.ChannelType.ADB) {
                    ...
                    if (!CoroutineScopeKt.isActive($this$launch)) {
                        ...
                        if ($this$request$iv$iv$iv$iv != null) {
                            String urlString$iv = baseUrl + "/api/frame"
                            ...
                            HttpTimeoutKt.timeout($this$get_u24lambda_u244$iv, Function1() { // from class: com.phonehub.ConnectionManager$startPcFramePolling$1$$ExternalSyntheticLambda0
                                override
                                fun invoke(obj: Any): Any {
                                    Unit invokeSuspend$lambda$1$lambda$0
                                    invokeSuspend$lambda$1$lambda$0 = ConnectionManager$startPcFramePolling$1.invokeSuspend$lambda$1$lambda$0((HttpTimeout.HttpTimeoutCapabilityConfiguration) obj)
                            ...
                            if (Intrinsics.areEqual(status, HttpStatusCode.INSTANCE.getOK())) {
                                ...
                                if (!(bytes.length != 0)) {
                                    ...
                                    mutableSharedFlow2 = ConnectionManager._pcFrame
                                    this.L$0 = $this$launch
                                    this.L$1 = baseUrl4
                                    this.L$2 = resp
                                    this.label = 3
                                    if (mutableSharedFlow2.emit(bytes, this) == coroutine_suspended) {
                                        var coroutine_suspended: return? = null
                                        }
                                    $result4 = $result5
                                    baseUrl3 = baseUrl4
                                    }
                                val str: String = resp.getHeaders().get("X-Cursor-X")
                                cx = str != null ? StringsKt.toFloatOrNull(str) : null
                                val str2: String = resp.getHeaders().get("X-Cursor-Y")
                                val cy: Float = str2 != null ? StringsKt.toFloatOrNull(str2) : null
                                if (cx != null || cy == null) {
                                    $result3 = $result4
                                    baseUrl2 = baseUrl3
                                    $this$launch2 = $this$launch
                                    ...
                                    mutableSharedFlow = ConnectionManager._pcCursorPos
                                    this.L$0 = $this$launch
                                    this.L$1 = baseUrl3
                                    this.L$2 = null
                                    this.label = 4
                                    if (mutableSharedFlow.emit(Pair(cx, cy), this) == coroutine_suspended) {
                                        var coroutine_suspended: return? = null
                                        }
                                    $result3 = $result4
                                    baseUrl2 = baseUrl3
            ...
            val str3: String = resp.getHeaders().get("X-Cursor-X")
            if (str3 != null) {
                }
            val str22: String = resp.getHeaders().get("X-Cursor-Y")
            if (str22 != null) {
                }
            if (cx != null) {
                }
            ...
            val str32: String = resp.getHeaders().get("X-Cursor-X")
            if (str32 != null) {
                }
            val str222: String = resp.getHeaders().get("X-Cursor-Y")
            if (str222 != null) {
                }
            if (cx != null) {
                }
